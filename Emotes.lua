...
local function blackjackUI()
	if blackjackBG then
		...
		blackjackTxt = blackjackBG:CreateFontString(nil, "Overlay", "GameTooltipText")
		...
		deckTxt = blackjackBG:CreateFontString(nil, "Overlay", "GameTooltipText")
		deckTxt:SetPoint("TOP","blackjackBG",0,-33)
		deckTxt:SetText("Cards Remaining: "..CurrentCard)
		deckTxt:SetFont("Fonts\\FRIZQT__.ttf", 12)

		dealerTxt = blackjackBG:CreateFontString(nil, "Overlay", "GameTooltipText")
